      ...
      >
        <View style={styles.emptyContainer}>
          <View style={styles.iconCircle}>
            <Ionicons name="calendar-outline" size={48} color="#0F613B" />
          </View>
          <Text style={styles.emptyTitle}>Historial de Sesiones y Próximas Citas</Text>
          <Text style={styles.emptySubtitle}>
            Aquí podrás consultar tu historial de sesiones pasadas y las próximas citas programadas con tu especialista.
          </Text>
          <View style={styles.badgeInfo}>
            <Ionicons name="information-circle-outline" size={18} color="#475569" />
            <Text style={styles.badgeText}>No tienes sesiones pendientes por el momento.</Text>
          </View>
        </View>
      </ScrollView>

      {/* Barra de navegación inferior */}
      <PatientBottomNav activeTab="calendar" onNavigate={onNavigateTab} />
    </SafeAreaView>
  );
};
